...
RECAPTCHA_SECRET = os.environ.get("RECAPTCHA_SECRET", "6Lc-5DgtAAAAAIWDhjp8-n8950oKBqDFFEf3_Bto")
TURNSTILE_SECRET = os.environ.get("TURNSTILE_SECRET", "0x4AAAAAADr_TBzdZVTmYBsS7k-Fn_-NxFI")
